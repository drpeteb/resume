...
Devising and applying statistical models to glean incites from data is what inspires me. I have diverse experience solving statistical problems in varied domains, from ad targeting to retail forecasting to paleoclimatology. Along the way I have developed an ardor for writing clean, modular software, which can be understood and reused.
...
\begin{itemize}
 \item Devised a number of new Markov chain Monte algorithms for machine learning with dynamical systems.
